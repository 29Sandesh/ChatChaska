        ...
        {accessInfo?.showWarning && accessInfo.warningMessage && (
          <div className="bg-amber-500 text-slate-950 font-bold px-4 py-2 text-xs flex items-center justify-between shadow-sm select-none border-b border-amber-600">
            ...
            <a
              ...
              className="bg-slate-950 hover:bg-slate-800 text-white px-3 py-1 rounded-lg text-[11px] font-extrabold uppercase tracking-wide transition-all shadow-xs"
            >
            ...
            <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center space-y-5 shadow-2xl border border-slate-200">
              ...
              <div className="flex flex-col gap-2">
                <a
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-3 rounded-xl text-xs transition-all shadow-md"
                >
